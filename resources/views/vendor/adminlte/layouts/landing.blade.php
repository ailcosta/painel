...
<head>
    ...
    <meta name="author" content="Ailton Costa - acacha.org">

    <meta property="og:title" content="Adminlte-laravel" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="Adminlte-laravel - {{ trans('message.landingdescription') }}" />
    <meta property="og:url" content="http://demo.adminlte.acacha.org/" />
    <meta property="og:image" content="http://demo.adminlte.acacha.org/img/AcachaVill@ Coisa.png" />
    <meta property="og:image" content="http://demo.adminlte.acacha.org/img/AcachaVill@ Coisa600x600.png" />
    <meta property="og:image" content="http://demo.adminlte.acacha.org/img/AcachaVill@ Coisa600x314.png" />
    <meta property="og:sitename" content="demo.adminlte.acacha.org" />
    <meta property="og:url" content="http://demo.adminlte.acacha.org" />

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@villacoisa" />
    <meta name="twitter:creator" content="@villacoisa" />
                ...
                <div class="row centered">
                    <div class="col-lg-12">
                        ...
                        <h3>A <a href="https://laravel.com/">Laravel</a> {{ trans('message.laravelpackage') }}
                            scaffolding/boilerplate {{ trans('message.to') }} <a href="https://almsaeedstudio.com/preview">Vill@ Coisa</a> {{ trans('message.templatewith') }}
        ...
        <div id="c">
            <div class="container">
                <p>
                    ...
                    <strong>Copyright &copy; 2017 <a href="http://villacoisa.com.br">Vill@ Coisa</a>.</strong> {{ trans('message.createdby') }} <a href="https://villacoisa.com.br">Vill@ Coisa</a>. {{ trans('message.seecode') }} <a href="https://villacoisa.com.br">Vill@Coisa</a>
                    <br/>
                    Vill@ Coisa {{ trans('message.createdby') }} Abdullah Almsaeed <a href="https://almsaeedstudio.com/">almsaeedstudio.com</a>
                    <br/>
                    Pratt Landing Page PROVA {{ trans('message.createdby') }} <a href="http://www.blacktie.co">BLACKTIE.CO</a>
                </p>
